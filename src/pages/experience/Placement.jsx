...
const apps = [
  ...
  ["CVLink New", "4", "112", "32", "—", "Majority bug fixes"],
  ["HGV Toolbox", "4", "684", "24", "—", "Created new pages and functionality"],
  ["SSO", "2", "156", "1", "—", "Majority .NET upgrades"],
  ["Client Portal", "1", "8", "7", "—", ".NET upgrades"],
  ["Home/CVConnect", "1", "0", "1", "—", ".NET upgrades"],
  ["Document Service", "1", "0", "1", "C# · Razor", ".NET upgrades"],
];
...
export default function Placement({ onBack }) {
  return (
    <DetailLayout
      ...
      introText={<>
        <div>🌸 I relocated from <strong style={{ fontFamily: "monospace" }}>Essex</strong>, to <strong style={{ fontFamily: "monospace" }}>Portsmouth</strong>, to <strong style={{ fontFamily: "monospace" }}>Leeds</strong> to be a Placement student At Zenith.</div>
