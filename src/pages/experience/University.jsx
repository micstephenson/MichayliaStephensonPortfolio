...
export default function University({ onBack }) {
  return (
    <DetailLayout
      ...
      summary={
        <>
          🌸 BSc Software Engineering (Hons) with an optional placement.
          <br />
          🌸 Building a broad foundation across software development, databases and usability.
        </>
      }
      introTitle={<>Learning<br /><em>the craft.</em></>}
      introText={
        <>
          🌸 My degree has taken me from database design and SQL to web programming, software engineering practice and ethical hacking.
          <br />
          🌸 It has also given me opportunities to work in teams, communicate technical decisions and independently deepen my skills.
        </>
      }
