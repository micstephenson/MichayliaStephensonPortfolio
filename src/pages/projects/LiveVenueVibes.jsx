...
export default function LiveVenueVibes({ onBack }) {
  return (
    <DetailLayout
      ...
      summary={
        <>
          🌸 A real-time venue discovery concept.
          <br />
          🌸 People can see the atmosphere of a place before they arrive.
        </>
      }
      introTitle={<>The idea<br /><em>behind it.</em></>}
      introText={
        <>
          🌸 The concept combines a live map, location-aware venue activity, ratings, comments and trends over time.
          <br />
          🌸 The goal is to turn the question “what is this place like right now?” into something people can answer before they commit to going.
        </>
      }
